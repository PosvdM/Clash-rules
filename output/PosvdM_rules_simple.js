...
const policy = {
  ...
  "rules": [
    ...
    "RULE-SET,sukka_non_ip_ai,🚀 节点选择",
    "RULE-SET,local_ai,🚀 节点选择",
    "RULE-SET,local_proxy,🚀 节点选择",
    "RULE-SET,local_bulk,🚀 节点选择",
    "RULE-SET,local_sexy,🚀 节点选择",
    ...
    "RULE-SET,external_Global_Services_YouTube_non_ip,🚀 节点选择",
    ...
    "RULE-SET,sukka_non_ip_telegram,🚀 节点选择",
    "RULE-SET,external_Clash_GamePlatform,🚀 节点选择",
    "RULE-SET,sukka_non_ip_global,🚀 节点选择",
    "GEOSITE,cn,🟢 直连",
    "RULE-SET,local_SteamDownload_ip,🟢 直连,no-resolve",
    "RULE-SET,external_Global_Services_YouTube_ip,🚀 节点选择,no-resolve",
    "RULE-SET,sukka_ip_stream,🚀 节点选择,no-resolve",
    "RULE-SET,external_Ruleset_GoogleFCM_ip,🟢 直连,no-resolve",
    "RULE-SET,sukka_ip_telegram,🚀 节点选择,no-resolve",
    "RULE-SET,sukka_ip_telegram_asn,🚀 节点选择,no-resolve",
